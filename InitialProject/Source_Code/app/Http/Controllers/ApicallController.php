...
class ApicallController extends Controller
{
    ...
    public function callAll($id)
    {
        ...
        $googleScholarResponse = $googleScholarController->create($id);
        ...
        return redirect()->back()->with('success', 'เรียกข้อมูลจาก Scopus, Google Scholar สำเร็จ');
    }
}

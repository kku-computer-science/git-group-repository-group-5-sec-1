...
<script>
    ...
    function toggleDropdown(selObj) {
        // Show/hide fund level dropdown based on fund type
        if (selObj.value === "ทุนภายใน") {
            ...
            fundLevelSelect.value = ""; // Reset fund level when hidden
        }
        checkFormValidity();
    }
    ...
    fundTypeSelect.addEventListener('change', checkFormValidity);

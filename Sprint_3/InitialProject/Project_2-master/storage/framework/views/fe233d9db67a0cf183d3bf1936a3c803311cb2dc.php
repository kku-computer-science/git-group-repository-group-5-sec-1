                ...
                <table id="example1" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($fund->category->fundType->name); ?></td>
                            <td><?php echo e($fund->category->name); ?></td>
                                ...
                                <td>
                                    ...
                                    <form action="<?php echo e(route('funds.destroy', $fund->id)); ?>" method="POST">
                                        ...
                                        <li class="list-inline-item">
                                            ...
                                            href="<?php echo e(route('funds.edit', $fund->id)); ?>">
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8-3-68\git-group-repository-group-5-sec-1\Sprint_3\InitialProject\Project_2-master\resources\views/funds/index.blade.php ENDPATH**/ ?>
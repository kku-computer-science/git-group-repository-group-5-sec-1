...
class ResearchProject extends Model
{
    ...
    public function fund()
    {
        ...
        return $this->belongsTo(Fund::class, "fund_id")->with(
            "category.fundType"
        );
    }
    public function responsibleDepartmentResearchProject()
    {
        return $this->hasMany(
            ResponsibleDepartmentResearchProject::class,
